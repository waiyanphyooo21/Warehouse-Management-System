...
<head>
  ...
  <title>Ngwe Pone Gyi - Customer List</title>
  <!-- Bootstrap CSS -->
...
<div class="main-content">
  ...
  <h3 class="mb-4">${warehouse.warehouseId == 0 ? "Add New Warehouse" : "Edit Warehouse"}</h3>

  <form action="${pageContext.request.contextPath}${warehouse.warehouseId == 0 ? '/warehouse/add' : '/warehouse/edit'}" method="post">
    <c:if test="${warehouse.warehouseId != 0}">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="warehouseName" id="warehouseName" class="form-control"
             value="${warehouse.warehouseName != null ? warehouse.warehouseName : ''}" required>
    </div>

    <div class="mb-3">
      <label for="warehouseAddress" class="form-label">Address</label>
      <textarea name="warehouseAddress" id="warehouseAddress" class="form-control" rows="3">${warehouse.warehouseAddress != null ? warehouse.warehouseAddress : ''}</textarea>
    </div>

    <div class="mb-3">
      <label for="warehouseLevel" class="form-label">Level</label>
      <input type="text" name="warehouseLevel" id="warehouseLevel" class="form-control"
             value="${warehouse.warehouseLevel != null ? warehouse.warehouseLevel : ''}">
    </div>
    ...
    <div class="mb-3">
      ...
      <input type="text" name="warehouseLocation" id="warehouseLocation" class="form-control"
             value="${warehouse.warehouseLocation != null ? warehouse.warehouseLocation : ''}">
    </div>

    <div class="mb-3">
      <label for="warehouseLineNumber" class="form-label">Line Number</label>
      <input type="text" name="warehouseLineNumber" id="warehouseLineNumber" class="form-control"
             value="${warehouse.warehouseLineNumber != null ? warehouse.warehouseLineNumber : ''}">
    </div>

    <div class="d-flex justify-content-between">
      <a href="${pageContext.request.contextPath}/warehouse/list" class="btn btn-secondary">Cancel</a>
      <button type="submit" class="btn btn-orange">Save Warehouse</button>
    </div>
  </form>
