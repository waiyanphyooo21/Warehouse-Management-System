...
<div class="main-content">
  ...
  <h3 class="mb-4">Warehouse List</h3>

  <div class="mb-3 text-end">
    <a href="${pageContext.request.contextPath}/warehouse/add" class="btn btn-orange">
    ...
    <table class="table table-striped table-bordered align-middle">
      ...
      <c:forEach var="warehouse" items="${warehouses}" varStatus="status">
        <tr>
          ...
          <td>${warehouse.warehouseLineNumber}</td>
          <td class="text-center">
            <a href="${pageContext.request.contextPath}/warehouse/edit/${warehouse.warehouseId}" class="btn btn-sm btn-outline-primary me-1" title="Edit">
              <i class="fas fa-edit"></i>
            </a>
            <a href="${pageContext.request.contextPath}/warehouse/delete/${warehouse.warehouseId}" class="btn btn-sm btn-outline-danger" title="Delete" onclick="return confirm('Are you sure you want to delete this warehouse?');">
