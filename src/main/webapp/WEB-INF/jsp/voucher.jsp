...
<head>
  ...
  <title>Ngwe Pone Gyi - Voucher List</title>
  <!-- Bootstrap CSS -->
  ...
  <div class="container mt-5">
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered text-center">
        ...
        <tbody>
        <!-- Manually added example rows -->
        <tr>
          <td>101</td>
          <td>Two Elephants Cement</td>
          <td>High quality cement for construction</td>
          <td>Cement</td>
          <td>2025-07-01</td>
          <td>
            <form action="${pageContext.request.contextPath}/voucher/pdf/101" method="get">
              <button type="submit" class="btn btn-sm btn-danger">PDF</button>
            </form>
          </td>
        </tr>
        <tr>
          <td>102</td>
          <td>Iron Dragon Bricks</td>
          <td>Clay bricks for building walls</td>
          <td>Bricks</td>
          <td>2025-07-05</td>
          <td>
            <form action="${pageContext.request.contextPath}/voucher/pdf/102" method="get">
              <button type="submit" class="btn btn-sm btn-danger">PDF</button>
            </form>
          </td>
        </tr>
        <tr>
          <td>103</td>
          <td>Flame Steel</td>
          <td>Reinforcement steel bars</td>
          <td>Steel</td>
          <td>2025-07-10</td>
          <td>
            <form action="${pageContext.request.contextPath}/voucher/pdf/103" method="get">
              <button type="submit" class="btn btn-sm btn-danger">PDF</button>
            </form>
          </td>
        </tr>

        <!-- Your dynamic loop if needed -->
        <c:forEach var="item" items="${items}">
          <tr>
            ...
            <td>
              <form action="${pageContext.request.contextPath}/voucher/pdf/${item.itemId}" method="get">
                <button type="submit" class="btn btn-sm btn-danger">PDF</button>
              </form>
            </td>
          </tr>
