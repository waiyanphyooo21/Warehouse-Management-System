...
<div class="sidebar d-none d-lg-block">
    <div class="nav-menu">
        ...
        <div class="nav-item ${param.active == 'product-add' ? 'active' : ''}">
            <a href="${pageContext.request.contextPath}/product/add" class="nav-link ${active == 'product' ? 'text-danger' : ''}">
...
<div class="main-content">
    ...
    <div class="mb-3 text-end">
        <a href="${pageContext.request.contextPath}/customers/add" class="btn btn-orange">
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <c:forEach var="customer" items="${customers}" varStatus="status">
                <tr>
                    ...
                    <td class="text-center">${customer.customerPh}</td>
                    <td>${customer.customerAddress}</td>
                    <td class="text-center">
                        <a href="${pageContext.request.contextPath}/customers/edit/${customer.customerId}" class="btn btn-sm btn-outline-primary me-1" title="Edit">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="${pageContext.request.contextPath}/customers/delete/${customer.customerId}" class="btn btn-sm btn-outline-danger" title="Delete" onclick="return confirm('Are you sure you want to delete this customer?');">
