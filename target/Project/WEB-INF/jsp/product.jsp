...
<head>
  ...
  <title>Ngwe Pone Gyi - Product List</title>
  <!-- Bootstrap CSS -->
...
<div class="sidebar d-none d-lg-block">
  <div class="nav-menu">
    ...
    <div class="nav-item ${active == 'product' ? 'active' : ''}">
      <a href="${pageContext.request.contextPath}/products" class="nav-link ${active == 'product' ? 'active' : ''}">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="mobileSidebar">
  ...
  <div class="offcanvas-body">
    <div class="nav-menu">
      ...
      <div class="nav-item ${active == 'product' ? 'active' : ''}">
        <a href="${pageContext.request.contextPath}/products" class="nav-link ${active == 'product' ? 'text-danger' : ''}">
          <i class="fas fa-box me-2"></i>Products
        </a>
      </div>
      <div class="nav-item ${active == 'customer' ? 'active' : ''}">
...
<div class="main-content">
  ...
  <div class="mb-3 text-end">
    <a href="${pageContext.request.contextPath}/products/add" class="btn btn-orange">
    ...
    <table class="table table-striped table-bordered align-middle">
      ...
      <c:forEach var="product" items="${products}" varStatus="status">
        <tr>
          ...
          <td class="text-end">${product.purchasePrice}</td>
          <td class="text-end">${product.salePrice}</td>
          <td>${product.unit != null ? product.unit.unitName : ''}</td>
          <td>${product.description}</td>
          <td class="text-center">
            <a href="${pageContext.request.contextPath}/products/edit/${product.productId}" class="btn btn-sm btn-outline-primary me-1" title="Edit">
              <i class="fas fa-edit"></i>
            </a>
            <a href="${pageContext.request.contextPath}/products/delete/${product.productId}" class="btn btn-sm btn-outline-danger" title="Delete" onclick="return confirm('Are you sure you want to delete this product?');">
...
<%--          </a>--%>
<%--          <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="userDropdown">--%>
<%--            &lt;%&ndash;            <li class="dropdown-header">${user.name}</li>&ndash;%&gt;--%>
<%--            <c:if test="${not empty sessionScope.loggedInUser}">--%>
<%--              <li class="dropdown-header">${sessionScope.loggedInUser.fullName}</li>--%>
<%--            </c:if>--%>
<%--            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/user/edit">Profile</a></li>--%>
<%--            &lt;%&ndash;            <li><hr class="dropdown-divider" /></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;            <li><a class="dropdown-item text-danger" href="${pageContext.request.contextPath}/logout">Logout</a></li>&ndash;%&gt;--%>
<%--            <li>--%>
<%--              <a href="#"--%>
<%--                 class="dropdown-item text-danger"--%>
<%--                 data-bs-toggle="modal"--%>
