...
<head>
  ...
  <title>Ngwe Pone Gyi - Add Customer</title>
  <!-- Bootstrap CSS -->
...
<div class="main-content">
  ...
  <h3 class="mb-4">${customer.customerId == null ? "Add New Customer" : "Edit Customer"}</h3>

  <form action="${pageContext.request.contextPath}${customer.customerId == null ? '/customers/add' : '/customers/edit'}" method="post">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="customerName" id="customerName" class="form-control"
             value="${customer.customerName != null ? customer.customerName : ''}" required>
    </div>

    <div class="mb-3">
      <label for="customerPh" class="form-label">Phone</label>
      <input type="text" name="customerPh" id="customerPh" class="form-control"
             value="${customer.customerPh != null ? customer.customerPh : ''}">
    </div>

    <div class="mb-3">
      <label for="customerAddress" class="form-label">Address</label>
      <textarea name="customerAddress" id="customerAddress" class="form-control" rows="3">${customer.customerAddress != null ? customer.customerAddress : ''}</textarea>
    </div>

    <div class="d-flex justify-content-between">
      <a href="${pageContext.request.contextPath}/customers" class="btn btn-secondary">Cancel</a>
      <button type="submit" class="btn btn-orange">Save Customer</button>
    </div>
  </form>
</div>
